 ...
 */
public final class Directive extends AssemblyTextItem {
    ...
    public Directive(String prefix, int size) {
        this.name = prefix + " " + size;
    }

    public Directive(String prefix, String str) {
