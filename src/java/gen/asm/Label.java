 ...
 */
public final class Label extends AssemblyTextItem {
    /**
     * The label's unique name.
     */
    public final String name;

    private static final String FUNCTION_POSTFIX = "_FUNCTION";
    private static final String FUNCTION_EPILOGUE_POSTFIX = FUNCTION_POSTFIX + "_EPILOGUE";
    ...
    public static Label createFunDefLabel(String name) {
        return get(name + "_" + "FUNCTION");
    }

    public static Label createEpilogueLabel(String name) {
        return get(name + "_" + "FUNCTION" + "_" + "EPILOGUE");
    }

    public static Label getFunctionLabel(String name) {
        return instances.computeIfAbsent(name + FUNCTION_POSTFIX, Label::new);
    }

    public static Label getEpilogueLabel(String name) {
        return instances.computeIfAbsent(name + FUNCTION_EPILOGUE_POSTFIX, Label::new);
    }
